...
## Cloud Firestore：一个基于非关系型数据库的云端数据库服务 非关系型数据库适合读大于写的场景
...
- 分页
  - ![alt text](image-3.png) limit 函数简单的限制了查询数量（前 20 个）
  - ![alt text](image-4.png) 随后即可使用 start 函数进行某一个文档后的精确查询
...
## Swagger UI: https://zhuanlan.zhihu.com/p/703966719
